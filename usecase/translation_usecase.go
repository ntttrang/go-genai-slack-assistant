...
func (tu *TranslationUseCase) Translate(req domain.TranslationRequest) (domain.TranslationResponse, error) {
	...
	if err != nil {
		return domain.TranslationResponse{}, fmt.Errorf("translation failed: %w", err)
	}
	...
	if err := tu.repo.Save(translation); err != nil {
		return domain.TranslationResponse{}, fmt.Errorf("failed to save translation: %w", err)
	}
